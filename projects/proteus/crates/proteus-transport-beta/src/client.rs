...
impl BetaClientConnection {
    ...
    pub fn stats(&self) -> BetaConnectionStats {
        ...
        BetaConnectionStats {
            ...
            packet_threshold_lost_packets: stats.path.packet_threshold_lost_packets,
            time_threshold_lost_packets: stats.path.time_threshold_lost_packets,
            spurious_lost_packets: stats.path.spurious_lost_packets,
            spurious_packet_threshold_lost_packets: stats
                .path
