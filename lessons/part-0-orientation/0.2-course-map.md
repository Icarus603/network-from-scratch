...
- **Spaced repetition / interleaved practice**：認知科學裡「混合動力版」策略 C 的學名是 **interleaved practice**——主動在不同主題間切換，比 **blocked practice**（一個主題學完才換）長期保留率高。經典實驗：Rohrer & Taylor, *The shuffling of mathematics problems improves learning*, **Instructional Science** 35(6) 2007（同篇同時驗證 spacing + interleaving 兩個效應；mixed vs blocked 差距 +43 percentage points；[完整札記](../../notes/papers/rohrer-taylor-shuffling.md)）。同類概念 *spaced repetition*（隔週複習）對長期記憶更有效，*Distributed Practice in Verbal Recall Tasks* (Cepeda et al., *Psychological Bulletin* 2006) 是 meta-analysis 金本位。
