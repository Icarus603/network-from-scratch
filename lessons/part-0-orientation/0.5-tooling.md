...
code --install-extension charliermarsh.ruff             # Python linter / formatter
code --install-extension ms-vscode.cpptools             # C/C++（無 compile_commands.json 時的預設）
code --install-extension llvm-vs-code-extensions.vscode-clangd  # 有 compile_commands.json 時更精準
code --install-extension bierner.markdown-mermaid       # Mermaid 預覽（Markdown 用）
code --install-extension bierner.markdown-preview-github-styles
code --install-extension yzhang.markdown-all-in-one
code --install-extension davidanson.vscode-markdownlint
code --install-extension tlaplus.vscode-ide             # TLA+（2026 官方版；舊的 alygin.vscode-tlaplus 已停更）
code --install-extension myriad-dreamin.tinymist        # Typst（2024-11 typst-lsp archived，tinymist 是接班者）
code --install-extension tamasfe.even-better-toml
code --install-extension ms-vscode-remote.remote-ssh    # 編輯遠端 VPS 檔案
