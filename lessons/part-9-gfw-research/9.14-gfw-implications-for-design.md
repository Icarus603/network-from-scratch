...
4. **G6 設計空間**：我們新協議的 design space 已被 Part 9 收窄到具體 sub-space，本堂把它劃出來。
...
對 5 個現有 SOTA（SS-2022, VMess+WS, Trojan-Go, VLESS+REALITY, Hysteria2）跑同樣 20 攻擊面 check，產出 comparison matrix。輸出 `assets/spec/g6-design-space-comparison.md`。
