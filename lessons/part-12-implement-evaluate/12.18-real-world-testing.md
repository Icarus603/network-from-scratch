...
|---|---|---:|---:|---:|---:|---|
| 04-15 | G6 γ (MASQUE) | 99.4% | 285 | 612 | 0 | normal |
| 04-15 | G6 β (REALITY-on-QUIC) | 99.1% | 248 | 580 | 0 | normal |
| 04-15 | G6 α (REALITY-on-TCP) | 99.7% | 220 | 487 | 0 | normal |
| 04-15 | VLESS+REALITY | 98.9% | 218 | 472 | 0 | baseline |
| 04-15 | Hysteria 2 vanilla | 73% | 320 | 480 | 9 | QoS dropping UDP |
| 04-16 | G6 γ | 99.6% | 287 | 608 | 0 | normal |
| 04-17 | G6 γ | 95.2% | 612 | 234 | 0 | **degradation noticed** — investigation reveals MASQUE H/3 setting drift |
| 04-17 | G6 β | 99.0% | 252 | 591 | 0 | fallback to β works |
| 04-18 | G6 γ | 99.4% | 281 | 615 | 0 | fix deployed |
| 04-19 | All | similar | similar | similar | 0 | normal |
| 04-20 | All TCP/443 | **0%** | timeout | 0 | unknown | **GFW blackout event** (similar to 2025-08-20) |
| 04-20 | G6 γ (UDP) | 99.2% | 290 | 605 | 0 | UDP path survives → γ profile validates |
| 04-20 | G6 β (UDP) | 99.0% | 251 | 588 | 0 | UDP survives |
| 04-20 | G6 α (TCP) | 0% | timeout | 0 | many | **fallback to UDP triggered by client** |
| 04-21 | All TCP/443 | 99% | normal | normal | 0 | blackout cleared after ~6 hours |
| 04-22 | All | normal | normal | normal | 0 | normal |

**Interpretation guide**:

- Look for **diverging trends between G6 profiles**: 04-17 γ broke but β kept working → bug isolated to γ-specific code path (H/3 settings drift).
- Look for **all-profile-affected events**: 04-20 TCP/443 blackout → not our bug, external (GFW or upstream ISP) → G6 client auto-failed-over to UDP within < 5s (spec §3 requirement).
