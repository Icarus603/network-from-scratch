...
>
> **補遺**：[3.17 進階補遺：超越 SOTA 必備的密碼學深水區](./3.17-advanced-frontiers.md) — 本堂 §2 G6 v1 spec 在 3.17 升級為 v1.1（committing AEAD、KEMTLS Mode C、Bindel hybrid combiner、Double Ratchet-derived 粗粒度 PCS、嚴格 domain separation、XChaCha20 BBB、RAE error path）。Phase III 11.3 與 11.7 回頭引用。
